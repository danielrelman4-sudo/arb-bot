...
class CryptoSettings:
    ...
    # ── GARCH vol-spread model (v45) ──────────────────────────────
    garch_enabled: bool = False  # Use GARCH vol-spread as primary model
    ...
    garch_interval_seconds: int = 60          # Interval between observations (1-min)
...
def load_crypto_settings() -> CryptoSettings:
    ...
    return CryptoSettings(
        ...
        # v45 GARCH vol-spread
        garch_enabled=_as_bool(os.getenv("ARB_CRYPTO_GARCH_ENABLED"), False),
        ...
        garch_interval_seconds=_as_int(os.getenv("ARB_CRYPTO_GARCH_INTERVAL_SECONDS"), 60),
    )
